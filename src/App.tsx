...
const generateProductImages = (product: Product): string[] => {
  const placeholderIcons = [ImageIcon, Package, Eye, Zap, Star, Heart, Camera]

  if (product.id === "8") {
    // Louis Vuitton wallet – 6 real slides only
    const images = [
      `${import.meta.env.BASE_URL}louis-vuitton-multiple-wallet--M61695_PM1_Side-view3.png`,
      `${import.meta.env.BASE_URL}image.png`,
      `${import.meta.env.BASE_URL}slide-3.png`,
      `${import.meta.env.BASE_URL}slide-4.png`,
      `${import.meta.env.BASE_URL}slide-5.png`,
      `${import.meta.env.BASE_URL}slide-6.png`,
    ]
  ...
  if (product.id === "14") {
    ...
    return [
      `${import.meta.env.BASE_URL}clothing/acne-studios-super-baggy-fit/slide-1.png`,
      `${import.meta.env.BASE_URL}clothing/acne-studios-super-baggy-fit/slide-2.png`,
      `${import.meta.env.BASE_URL}clothing/acne-studios-super-baggy-fit/slide-3.png`,
      `${import.meta.env.BASE_URL}clothing/acne-studios-super-baggy-fit/slide-4.png`,
      `${import.meta.env.BASE_URL}clothing/acne-studios-super-baggy-fit/slide-5.png`,
    ]
  }
  ...
  if (product.id === "9") {
    ...
    return [
      `${import.meta.env.BASE_URL}shoes/gucci-angelina/slide-1.PNG`,
      `${import.meta.env.BASE_URL}shoes/gucci-angelina/slide-2.PNG`,
      `${import.meta.env.BASE_URL}shoes/gucci-angelina/slide-3.PNG`,
      `${import.meta.env.BASE_URL}shoes/gucci-angelina/slide-4.PNG`,
      `${import.meta.env.BASE_URL}shoes/gucci-angelina/slide-5.PNG`,
    ]
  }
  ...
  if (product.id === "11") {
    ...
    return [
      `${import.meta.env.BASE_URL}accessories/louis-vuitton-sunglasses/slide-1.PNG`,
      `${import.meta.env.BASE_URL}accessories/louis-vuitton-sunglasses/slide-2.PNG`,
      `${import.meta.env.BASE_URL}accessories/louis-vuitton-sunglasses/slide-3.PNG`,
      `${import.meta.env.BASE_URL}accessories/louis-vuitton-sunglasses/slide-4.PNG`,
    ]
  }
  ...
  if (product.id === "10") {
    ...
    return [
      `${import.meta.env.BASE_URL}shoes/gucci-horsebit-loafers/slide-1.PNG`,
      `${import.meta.env.BASE_URL}shoes/gucci-horsebit-loafers/slide-2.PNG`,
      `${import.meta.env.BASE_URL}shoes/gucci-horsebit-loafers/slide-3.PNG`,
      `${import.meta.env.BASE_URL}shoes/gucci-horsebit-loafers/slide-4.PNG`,
      `${import.meta.env.BASE_URL}shoes/gucci-horsebit-loafers/slide-5.PNG`,
    ]
  }
  ...
  if (product.id === "12") {
    ...
    return [
      `${import.meta.env.BASE_URL}shoes/louis-vuitton-comfort-mule/slide-1.PNG`,
      `${import.meta.env.BASE_URL}shoes/louis-vuitton-comfort-mule/slide-2.PNG`,
      `${import.meta.env.BASE_URL}shoes/louis-vuitton-comfort-mule/slide-3.PNG`,
    ]
  }
  ...
  if (product.id === "13") {
    ...
    return [
      `${import.meta.env.BASE_URL}shoes/sunset-flat-comfort-sandal/slide-1.PNG`,
      `${import.meta.env.BASE_URL}shoes/sunset-flat-comfort-sandal/slide-2.PNG`,
      `${import.meta.env.BASE_URL}shoes/sunset-flat-comfort-sandal/slide-3.PNG`,
      `${import.meta.env.BASE_URL}shoes/sunset-flat-comfort-sandal/slide-4.PNG`,
      `${import.meta.env.BASE_URL}shoes/sunset-flat-comfort-sandal/slide-5.PNG`,
    ]
  }
  ...
  if (product.id === "15") {
    ...
    return [
      `${import.meta.env.BASE_URL}clothing/acne-studios-digitally-printed-jeans-mid-blue/slide-1.PNG`,
      `${import.meta.env.BASE_URL}clothing/acne-studios-digitally-printed-jeans-mid-blue/slide-2.PNG`,
      `${import.meta.env.BASE_URL}clothing/acne-studios-digitally-printed-jeans-mid-blue/slide-3.png`,
      `${import.meta.env.BASE_URL}clothing/acne-studios-digitally-printed-jeans-mid-blue/slide-4.png`,
      `${import.meta.env.BASE_URL}clothing/acne-studios-digitally-printed-jeans-mid-blue/slide-5.png`,
    ]
  }
  ...
  return [
    ...
    ...Array(6)
      .fill(null)
      .map((_, index) => `placeholder-${placeholderIcons[index + 1].name}`),
  ]
}
...
const sampleProducts: Product[] = [
  {
    id: "8",
    name: "Louis Vuitton Slender Wallet",
    price: 125,
    image: `${import.meta.env.BASE_URL}louis-vuitton-multiple-wallet--M61695_PM1_Side-view3.png`,
  ...
  // ✅ Add your new items below the existing ones
  {
    ...
    name: "Gucci Angelina",
    price: 850,
    image: `${import.meta.env.BASE_URL}shoes/gucci-angelina/slide-1.PNG`,
    category: "shoes",
  },
  {
    id: "10",
    ...
    price: 720,
    image: `${import.meta.env.BASE_URL}shoes/gucci-horsebit-loafers/slide-1.PNG`,
    category: "shoes",
  },
  {
    id: "11",
    ...
    price: 450,
    image: `${import.meta.env.BASE_URL}accessories/louis-vuitton-sunglasses/slide-1.PNG`,
    category: "accessories",
  },
  {
    id: "12",
    name: "Louis Vuitton Comfort Mule",
    price: 680,
    image: `${import.meta.env.BASE_URL}shoes/louis-vuitton-comfort-mule/slide-1.PNG`,
    category: "shoes",
  },
  {
    id: "13",
    name: "Sunset Flat Comfort Sandal",
    price: 320,
    image: `${import.meta.env.BASE_URL}shoes/sunset-flat-comfort-sandal/slide-1.PNG`,
    category: "shoes",
  },
  {
    id: "14",
    name: "Acne Studios Super Baggy Fit",
    price: 280,
    image: `${import.meta.env.BASE_URL}clothing/acne-studios-super-baggy-fit/slide-1.png`,
    category: "clothing",
  },
  {
    id: "15",
    name: "Acne Studios Digital Print Jeans",
    price: 350,
    image: `${import.meta.env.BASE_URL}clothing/acne-studios-digitally-printed-jeans-mid-blue/slide-1.PNG`,
    category: "clothing",
  },
]
            ...
            {isPlaceholder ? (
              <div className="flex flex-col items-center justify-center text-gray-400 pb-24">
                {(() => {
                  ...
                  const IconComponent =
                    [ImageIcon, Package, Eye, Zap, Star, Heart, Camera].find((icon) => icon.name === iconName) ||
                    ImageIcon
      ...
      >
        ...
        {(pullDistance > 0 || isRefreshing) && (
          ...
          >
            <div className="flex items-center space-x-2 text-purple-600">
              <div
                className={`w-5 h-5 border-2 border-purple-600 rounded-full ${isRefreshing ? "animate-spin border-t-transparent" : ""}`}
              />
        ...
        <div className="max-w-lg mx-auto lg:max-w-6xl px-4 py-6">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">{selectedCategoryData?.name}</h1>
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">
                We're adding new {selectedCategoryData?.name.toLowerCase()} items. Check back soon!
              </p>
            </div>
          )}
        </div>
    ...
    >
      ...
      <div className="max-w-lg mx-auto lg:max-w-6xl px-4 py-6 lg:py-8">
        ...
        <div className="text-center mb-8 lg:mb-12">
          <h2 className="text-2xl lg:text-4xl font-bold text-gray-900 mb-4">🛍️ Shop by Category</h2>
          ...
          {categories.map((category) => {
            ...
            return (
              ...
              >
                ...
                <IconComponent
                  size={24}
                  className="text-purple-600 mx-auto mb-3 group-hover:scale-110 transition-transform duration-200"
                />
        ...
        <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-lg mb-8 lg:mb-12">
          <h3 className="text-xl lg:text-2xl font-bold text-gray-900 mb-6 flex items-center">
            <MapPin className="mr-2 text-purple-600" size={24} />📍 How It Works
          </h3>
        ...
        <div className="mb-8 lg:mb-12">
          <h3 className="text-xl lg:text-2xl font-bold text-gray-900 mb-6 text-center">🔥 Popular Items</h3>
